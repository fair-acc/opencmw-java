...
interface into an abstract implementation-independent wire-format using the [FieldDataSetHelper](../serialiser/src/main/java/io/opencmw/serialiser/spi/iobuffer/FieldDataSetHelper.java)
function.
