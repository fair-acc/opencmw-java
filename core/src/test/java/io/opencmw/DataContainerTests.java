...
/**
 * Tests of {@link io.opencmw.DataContainer}
 * 
 * @author rstein
 */
public class DataContainerTests {
    ...
    public void cornerCaseTests() {
        Assertions.assertDoesNotThrow(() -> DataContainer.fixPreAndPost("test"));
        ...
        Assertions.assertDoesNotThrow(() -> DataContainer.genExportName("test"));
        ...
        Assertions.assertDoesNotThrow(() -> DataContainer.genExportNameData("test.png"));
        ...
        Assertions.assertDoesNotThrow(() -> DataContainer.getCategory("test"));
